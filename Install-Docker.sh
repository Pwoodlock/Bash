...
# Updated function to install Docker on Debian-based systems as Docker repo isn't available on Noble of this last date of 23/09/2024 @patrick
install_docker_debian() {
    ...
    # Use 'mantic' instead of $VERSION_CODENAME for Ubuntu 24.04
    echo "deb [arch=$arch signed-by=/etc/apt/keyrings/docker.gpg] https://download.docker.com/linux/ubuntu mantic stable" | tee /etc/apt/sources.list.d/docker.list > /dev/null
